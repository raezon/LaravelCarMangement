...
class DemandeSansChauController extends Controller
{
        /**
        ...
        public function index(Request $request)
        {
            ...
            return view('demandes.DemandeSansChau.index', compact('demandesanschau'));
        }
        ...
        {
            return view('demandes.DemandeSansChau.create');
        }
        ...
        public function show($id)
        {
            ...
            return view('demandes.DemandeSansChau.show', compact('demandesanschau'));
        }
