...
class GesDemandeAvecChauController extends Controller
{
        /**
        ...
        public function index(Request $request)
        {
            ...
            return view('demandes.GesDemandeAvecChau.index', compact('demandeavecchau'));
        }
        ...
        {
            return view('demandes.GesDemandeAvecChau.create');
        }
        ...
        public function show($id)
        {
            ...
            return view('demandes.GesDemandeAvecChau.show', compact('demandeavecchau'));
        }
        ...
        public function edit($id)
        {
            ...
            return view('demandes.GesDemandeAvecChau.edit', compact('demandeavecchau'));
        }
