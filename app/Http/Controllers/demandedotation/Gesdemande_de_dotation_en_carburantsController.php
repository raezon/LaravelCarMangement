...
class Gesdemande_de_dotation_en_carburantsController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('demandes.Gesdemande_de_dotation_en_carburants.index', compact('demande_de_dotation_en_carburants'));
    }
    ...
    {
        return view('demandes.Gesdemande_de_dotation_en_carburants.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('Gesdemande_de_dotation_en_carburants')->with('flash_message', 'demande de dotationen carburants added!');
    }
    ...
    public function show($id)
    {
        ...
        return view('demandes.Gesdemande_de_dotation_en_carburants.show', compact('demande_de_dotation_en_carburants'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('demandes.Gesdemande_de_dotation_en_carburants.edit', compact('demande_de_dotation_en_carburants'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('Gesdemande_de_dotation_en_carburants')->with('flash_message', 'demande sans chauffeur updated!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('Gesdemande_de_dotation_en_carburants')->with('flash_message', 'Gestion demande de dotation en carburants deleted!');
    }
}
