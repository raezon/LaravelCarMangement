            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ url('/DemandeSansChau/' . $demandesanschau->id . '/edit') }}" title="Edit Demande"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit</button></a>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th>N_serie</th><td>{{ $demandesanschau->N_serie }}</td></tr>
