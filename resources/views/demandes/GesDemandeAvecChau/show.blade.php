            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ url('/GesDemandeAvecChau') }}" title="Back"><button class="btn btn-warning btn-sm"><i aria-hidden="true"></i>Back</button></a>
                      <!--  <a href="{{ url('/GesDemandeAvecChau/' . $demandeavecchau->id . '/edit') }}" title="Edit Demande"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a> -->
                      <a href="{{ route('GesDemandeAvecChau.create') }}" class="btn btn-primary btn-sm" title="Ajouter Bon">
                            <i aria-hidden="true"></i> Valider
                        </a> 
                        
                        <form method="POST" action="{{ url('GesDemandeAvecChau' . '/' . $demandeavecchau->id) }}" accept-charset="UTF-8" style="display:inline">
                            {{ method_field('DELETE') }}
                            {{ csrf_field() }}
